...
class CMsgProtoBufHeader(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CMSGPROTOBUFHEADER

  # @@protoc_insertion_point(class_scope:CMsgProtoBufHeader)

class CMsgMulti(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CMSGMULTI

  # @@protoc_insertion_point(class_scope:CMsgMulti)

class CMsgAuthTicket(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CMSGAUTHTICKET

  # @@protoc_insertion_point(class_scope:CMsgAuthTicket)

class CCDDBAppDetailCommon(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CCDDBAPPDETAILCOMMON

  # @@protoc_insertion_point(class_scope:CCDDBAppDetailCommon)

class CMsgAppRights(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
