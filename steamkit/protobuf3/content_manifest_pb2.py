...
class ContentManifestPayload(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  class FileMapping(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
...
class ContentManifestMetadata(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CONTENTMANIFESTMETADATA

  # @@protoc_insertion_point(class_scope:ContentManifestMetadata)

class ContentManifestSignature(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
